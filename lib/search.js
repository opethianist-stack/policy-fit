...
// 어절 끝의 조사·어미를 뗀다. 명사 끝 글자와 겹치기 쉬운 한 글자(이·가·도·로·등 …)는 떼지 않는다
// ("생활지도", "전문가", "초중등"이 잘리지 않게).
const JOSA = ['으로서', '으로써', '에서의', '에게서', '으로의', '에서는', '에서도', '이라는', '에서', '으로', '에게', '까지', '부터', '보다', '처럼', '이며', '이고', '하는', '하고', '하여', '하며', '되는', '되어', '되며', '한다', '된다', '하기', '적인', '적으로', '에는', '과의', '와의', '을', '를', '은', '는', '의', '에', '과', '와', '및'];
