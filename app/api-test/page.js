...
function makePresets() {
  return [
    ...
    },
    {
      ...
      keySource: 'data',
      keyParam: 'ServiceKey',
      endpoint: 'https://apis.data.go.kr/1721000/msitpressreleaseinfo/pressReleaseList',
      params: [
        { k: 'pageNo', v: '1' },
        { k: 'numOfRows', v: '10' },
        { k: 'returnType', v: 'json' },
      ],
      note: '응답: subject, pressDt, deptName, viewUrl(상세페이지), files[fileName, fileUrl]. 한 페이지 최대 10건, 키워드 검색 없음.',
    },
    {
      id: 'msit-notice',
      group: 'data',
    ...
    },
    {
      ...
      keySource: 'data',
      keyParam: 'ServiceKey',
      endpoint: 'https://apis.data.go.kr/1721000/msitpressexplaininfo/pressExplainList',
      params: [
        { k: 'pageNo', v: '1' },
        { k: 'numOfRows', v: '10' },
        { k: 'returnType', v: 'json' },
    ...
    },
    {
      ...
      params: [
        ...
        { k: 'numOfRows', v: '10' },
        { k: 'resultType', v: 'json' },
        { k: 'instNm', v: '한국교육학술정보원' },
      ],
      note: '오퍼레이션은 /list(기관 목록)와 /brnch(지점 목록, instCd 필수) 두 개입니다. /list 응답의 sprvsnInstNm(주관부처명)·sprvsnInstCd(주관부처코드)가 계보 매핑의 근거 필드입니다. instNm은 문자열 포함 조건으로 검색됩니다.',
    },
    {
      id: 'biz',
      group: 'data',
      ...
      keySource: 'data',
      keyParam: 'serviceKey',
      endpoint: 'https://apis.data.go.kr/1051000/biz/list',
      params: [
        { k: 'pageNo', v: '1' },
        { k: 'numOfRows', v: '10' },
        { k: 'resultType', v: 'json' },
      ...
      note: '오퍼레이션은 /list 하나입니다. 기관 단위로 좁히려면 공공기관 정보 조회에서 얻은 instCd를 파라미터로 추가합니다. bizNm은 문자열 포함 조건입니다.',
    },
    {
      id: 'alio-apba',
      group: 'alio',
